        ...
        <SafeAreaView className="flex-1 bg-white" >   
            <View className="w-full h-full justify-center gap-[12.5px]" >
                ...
                <View className="justify-center items-center gap-[12.5px]" >
                    ...
                    <Text className="w-[75%] text-[25px] text-center color-black font-Oregular" >Enviamos um código para seu email, verifique sua caixa de entrada</Text>

                    <Text className="text-[18.75px] color-black font-Obold mb-[10px]" >01:00</Text>

                    <Pressable className="w-[50%] h-[50px] border-solid border-green-800 border-[2px] justify-center items-center rounded-[12.5px]" >
                        <Link href={"/login"} >
