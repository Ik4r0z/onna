...
export default function RecoveryPassword() {
    return (
        <SafeAreaView className="flex-1 bg-white" >   
            <View className="w-full h-full justify-center gap-[62.5px]" >
                ...
                <View className="justify-center items-center gap-[12.5px]" >
                    ...
                    <Text className="w-[90%] text-[25px] text-center color-black font-Iregular" >Enviamos um código para seu email, verifique sua caixa de entrada</Text>

                    <Text className="text-[18.75px] color-black font-Obold mb-[10px]" >01:00</Text>

                    <Pressable className="w-[50%] h-[50px] bg-white border-solid border-green-800 border-[2px] justify-center items-center rounded-[12.5px] mb-[10px]" >
                        <Link href={"/login"} >
