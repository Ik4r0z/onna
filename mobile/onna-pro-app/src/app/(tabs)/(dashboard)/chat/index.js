...
import { SafeAreaView, StatusBar, View, Pressable, ActivityIndicator, Text } from "react-native";
...
export default function Chat() {
    ...
    useEffect(() => {
        ...
        console.log("Current user state:", user); // Log para acompanhar o estado do user
        if (user === undefined) {
    ...
    }, [user]); // Adicionei `user` como dependência para reativar quando houver mudanças
